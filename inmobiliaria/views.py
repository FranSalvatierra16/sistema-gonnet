    ...
    if form.is_valid():
        ...
        for propiedad in propiedades:
            ...
            if disponibilidad_base:
                ...
                # 🔍 DEBUGGING: Ver todas las reservas de esta propiedad
                todas_reservas = propiedad.reservas.all()
                print(f"📋 PROP {propiedad.id}: TODAS las reservas ({todas_reservas.count()}):")
                ...
                print(f"🔎 FILTRO: fecha_fin < {fecha_inicio} AND fecha_inicio >= {disponibilidad_base.fecha_inicio} AND fecha_fin <= {disponibilidad_base.fecha_fin}")
