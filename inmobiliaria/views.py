...
def alquileres_invierno(request):
    # Por defecto: sucursal del usuario. Con ver_todas=1: Colón y Corrientes juntas.
    ...
    # Opciones de ambientes para el filtro (mismo ámbito: sucursal o Colón/Corrientes)
