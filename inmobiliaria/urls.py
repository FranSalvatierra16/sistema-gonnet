...
urlpatterns = [
    ...
    path('web/hero-mardelplata.jpg', portal_views.portal_hero, name='portal_hero'),
    path('web/', portal_views.portal_home, name='portal_home'),
    path('web/buscar/', portal_views.portal_buscar, name='portal_buscar'),
    path('web/mapa-busqueda.js', portal_views.portal_mapa_js, name='portal_mapa_js'),
    ...
    path('reserva/recuperar/<int:reserva_id>/', views.reserva_recuperar, name='reserva_recuperar'),
    ...
    path(
        'oficina/propiedades/<str:propiedad_id>/libro/inicio-caja/',
        views_oficina.oficina_propiedad_libro_inicio_caja,
        name='oficina_propiedad_libro_inicio_caja',
    ),
    path(
        'oficina/propiedades/<str:propiedad_id>/libro/costos-compra/',
        views_oficina.oficina_propiedad_libro_costos_compra,
        name='oficina_propiedad_libro_costos_compra',
    ),
    path(
    ...
    path(
        'oficina/propiedades/<str:propiedad_id>/libro/importar-negro/',
        views_oficina.oficina_propiedad_libro_importar_negro,
    ...
    path(
        'contratos/<int:contrato_id>/dejar-adelanto-cuota/',
        views.dejar_adelanto_cuota_contrato_super_admin,
        name='dejar_adelanto_cuota_contrato_super_admin',
    ),
    path(
        'contratos/<int:contrato_id>/corregir-julio-agosto-311/',
        views.corregir_saldos_julio_agosto_311,
    ...
    path(
        'liquidaciones/<int:liquidacion_id>/confirmar-caratula/',
        views.confirmar_caratula_desde_liquidacion,
