...
urlpatterns = [
    ...
    path('propiedad/<str:propiedad_id>/precios/', views.gestionar_precios, name='gestionar_precios'),
    ...
    path('propiedades/<str:propiedad_id>/cambiar-sucursal/', views.propiedad_cambiar_sucursal, name='propiedad_cambiar_sucursal'),
    path('propiedades/<str:propiedad_id>/eliminar/', views.propiedad_eliminar, name='propiedad_eliminar'),
    path('propiedades-eliminadas/', views.propiedades_eliminadas, name='propiedades_eliminadas'),
    path('propiedades/<str:propiedad_id>/recuperar/', views.propiedad_recuperar, name='propiedad_recuperar'),
    path('propiedad/<str:propiedad_id>/crear-disponibilidad/', views.crear_disponibilidad, name='crear_disponibilidad'),
    ...
    path('propiedad/<str:propiedad_id>/eliminar-todas-imagenes/', views.eliminar_todas_imagenes, name='eliminar_todas_imagenes'),
    path('propiedades/<str:propiedad_id>/reordenar-imagenes/', views.reordenar_imagenes, name='reordenar_imagenes'),
    ...
    path('obtener-fotos-propiedad/<str:propiedad_id>/', views.obtener_fotos_propiedad, name='obtener_fotos_propiedad'),
    path('obtener-precios-propiedad/<str:propiedad_id>/', views.obtener_precios_propiedad, name='obtener_precios_propiedad'),
    ...
    path(
        'contratos/<int:contrato_id>/cuotas/precio-mes/',
        views.actualizar_precio_cuota_mes_contrato,
        name='actualizar_precio_cuota_mes_contrato',
    ),
    ...
    path('propiedades/<str:propiedad_id>/reactivar-24-meses/', views.reactivar_propiedad_24_meses, name='reactivar_propiedad_24_meses'),
    path('propiedades/<str:propiedad_id>/desactivar-24-meses/', views.desactivar_propiedad_24_meses, name='desactivar_propiedad_24_meses'),
    path('propiedades/<str:propiedad_id>/meses-info/', views.obtener_meses_info_ajax, name='obtener_meses_info_ajax'),
    path('actualizar-meses-ajax/', views.actualizar_meses_ajax, name='actualizar_meses_ajax'),
    path('propiedades/<str:propiedad_id>/editar-invierno/', views.editar_info_invierno, name='editar_info_invierno'),
    path('propiedades/<str:propiedad_id>/invierno-info/', views.obtener_invierno_info_ajax, name='obtener_invierno_info_ajax'),
    path('actualizar-invierno-ajax/', views.actualizar_invierno_ajax, name='actualizar_invierno_ajax'),
    path('propiedades/<str:propiedad_id>/reactivar-invierno/', views.reactivar_propiedad_invierno, name='reactivar_propiedad_invierno'),
    path('propiedades/<str:propiedad_id>/desactivar-invierno/', views.desactivar_propiedad_invierno, name='desactivar_propiedad_invierno'),
