# Generated by Django 4.2.7 on 2024-10-10 20:00
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tipo_precio', models.CharField(choices=[('QUINCENA_1_ENERO', '1ra quincena Enero'), ('QUINCENA_2_ENERO', '2da quincena Enero'), ('QUINCENA_1_FEBRERO', '1ra quincena Febrero'), ('QUINCENA_2_FEBRERO', '2da quincena Febrero'), ('QUINCENA_1_MARZO', '1ra quincena Marzo'), ('QUINCENA_2_MARZO', '2da quincena Marzo'), ('FINDE_LARGO', 'Finde largo'), ('DICIEMBRE', 'Diciembre'), ('ENERO', 'Enero'), ('FEBRERO', 'Febrero'), ('MARZO', 'Marzo')], max_length=20)),
                ('precio_total', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True)),
