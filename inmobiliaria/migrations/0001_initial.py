# Generated by Django 4.2.7 on 2024-08-29 14:24
...
import inmobiliaria.models.propiedad
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vista', models.CharField(choices=[('a_la_ calle', 'A la calle'), ('contrafrente', 'Contrafrente'), ('lateral', 'Lateral')], default='otro', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('imagen', models.ImageField(upload_to=inmobiliaria.models.propiedad.property_image_path)),
