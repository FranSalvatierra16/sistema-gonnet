# Generated by Django 4.2.7 on 2024-09-16 12:46
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tipo_precio', models.CharField(choices=[('quincena_1_enero', 'Primera Quincena de Enero'), ('quincena_2_enero', 'Segunda Quincena de Enero'), ('quincena_1_febrero', 'Primera Quincena de Febrero'), ('quincena_2_febrero', 'Segunda Quincena de Febrero'), ('quincena_1_marzo', 'Primera Quincena de Marzo'), ('quincena_2_marzo', 'Segunda Quincena de Marzo'), ('finde_largo', 'Fin de Semana Largo')], max_length=20)),
